...
<head>
    ...
    <title>Robert's Book Store - Classics</title>
...
<div class="container page_border">
    ...
    <div class="topbar">
        ...
        <select class="form-control genre_select" onchange="if(this.value) window.location.href=this.value;">
            ...
            <option value="classics.php" selected>Classics</option>
    ...
    <div class="pic_group">
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/hamlet.jpg" data-toggle="tooltip" data-placement="bottom" title="Hamlet" alt="Hamlet">
            </div>
            <div class="item_label">
                <span class="book_title">Hamlet</span>
                <span class="book_price">P350.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/king_lear.jpg" data-toggle="tooltip" data-placement="bottom" title="King Lear" alt="King Lear">
            </div>
            <div class="item_label">
                <span class="book_title">King Lear</span>
                <span class="book_price">P350.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/macbeth.jpg" data-toggle="tooltip" data-placement="bottom" title="Macbeth" alt="Macbeth">
            </div>
            <div class="item_label">
                <span class="book_title">Macbeth</span>
                <span class="book_price">P350.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/misummer_night_dream.jpg" data-toggle="tooltip" data-placement="bottom" title="A Midsummer Night's Dream" alt="A Midsummer Night's Dream">
            </div>
            <div class="item_label">
                <span class="book_title">A Midsummer Night's Dream</span>
                <span class="book_price">P350.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/othello.jpg" data-toggle="tooltip" data-placement="bottom" title="Othello" alt="Othello">
            </div>
            <div class="item_label">
                <span class="book_title">Othello</span>
                <span class="book_price">P350.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/romeo_juliet.jpg" data-toggle="tooltip" data-placement="bottom" title="Romeo and Juliet" alt="Romeo and Juliet">
            </div>
            <div class="item_label">
                <span class="book_title">Romeo and Juliet</span>
                <span class="book_price">P350.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/twelth_night.jpg" data-toggle="tooltip" data-placement="bottom" title="Twelfth Night" alt="Twelfth Night">
            </div>
            <div class="item_label">
                <span class="book_title">Twelfth Night</span>
                <span class="book_price">P350.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/cancer_ward.jpg" data-toggle="tooltip" data-placement="bottom" title="Cancer Ward" alt="Cancer Ward">
            </div>
            <div class="item_label">
                <span class="book_title">Cancer Ward</span>
                <span class="book_price">P890.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
