...
<head>
    ...
    <title>Robert's Book Store - Sci-Fi</title>
...
<div class="container page_border">
    ...
    <div class="topbar">
        ...
        <select class="form-control genre_select" onchange="if(this.value) window.location.href=this.value;">
            ...
            <option value="scifi.php" selected>Sci-Fi</option>
    ...
    <div class="pic_group">
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/version_control.jpg" data-toggle="tooltip" data-placement="bottom" title="Version Control" alt="Version Control">
            </div>
            <div class="item_label">
                <span class="book_title">Version Control</span>
                <span class="book_price">P720.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
        ...
        <div class="pic_option">
            <div class="pic_img">
                <img src="book_images/the_visible_man.jpg" data-toggle="tooltip" data-placement="bottom" title="The Visible Man" alt="The Visible Man">
            </div>
            <div class="item_label">
                <span class="book_title">The Visible Man</span>
                <span class="book_price">P680.00</span>
            </div>
        </div>
        <div class="pic_option">
            <div class="pic_img">
